...
CREATE OR REPLACE FUNCTION timeit.cmp(
    ...
    timeout interval DEFAULT '100 ms'::interval
)
RETURNS RECORD
LANGUAGE plpgsql
AS $$
...
declare
    ...
    overhead_time_a_3 bigint;
    overhead_time_a_4 bigint;
    overhead_time_b_1 bigint;
    overhead_time_b_2 bigint;
    overhead_time_b_3 bigint;
    overhead_time_b_4 bigint;
...
begin
    ...
    loop
        ...
        overhead_time_a_3 := timeit.overhead(executions);
        test_time_b_3 := timeit.measure(function_name_b, input_values_b, executions);
        overhead_time_b_3 := timeit.overhead(executions);
        test_time_a_4 := timeit.measure(function_name_a, input_values_a, executions);
        overhead_time_a_4 := timeit.overhead(executions);
        test_time_b_4 := timeit.measure(function_name_b, input_values_b, executions);
        overhead_time_b_4 := timeit.overhead(executions);

        avg_overhead_time := (overhead_time_a_1 + overhead_time_b_1 + overhead_time_a_2 + overhead_time_b_2 + overhead_time_a_3 + overhead_time_b_3 + overhead_time_a_4 + overhead_time_b_4) / 8;
        ...
        total_time_a_3 := test_time_a_3 - avg_overhead_time;
        total_time_b_3 := test_time_b_3 - avg_overhead_time;
        total_time_a_4 := test_time_a_4 - avg_overhead_time;
        total_time_b_4 := test_time_b_4 - avg_overhead_time;
        ...
        if greatest(total_time_a_1,total_time_a_2,total_time_a_3,total_time_a_4) < least(total_time_b_1,total_time_b_2,total_time_b_3,total_time_b_4)
